...
namespace IIS.Serezha
{
    ...
    public class Блюда : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Serezha.DetailArrayOfСоставБлюда fСоставБлюда;
        ...
        public virtual IIS.Serezha.DetailArrayOfСоставБлюда СоставБлюда
        {
            get
            {
                ...
                {
                    this.fСоставБлюда = new IIS.Serezha.DetailArrayOfСоставБлюда(this);
                }
                IIS.Serezha.DetailArrayOfСоставБлюда result = this.fСоставБлюда;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View БлюдаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("БлюдаE", typeof(IIS.Serezha.Блюда));
                }
            }
            ...
            public static ICSSoft.STORMNET.View БлюдаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("БлюдаL", typeof(IIS.Serezha.Блюда));
                }
            }
        }
    }
